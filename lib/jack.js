(function () {
  ...
  Jack.tokenize || (Jack.tokenize = require('./jack/lexer.js').Jack.tokenize);
  Jack.parse || (Jack.parse = require('./jack/grammar.js').Jack.parse);
  Jack.generate || (Jack.generate = require('./jack/generator.js').Jack.generate);
